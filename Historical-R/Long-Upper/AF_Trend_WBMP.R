...
filename <- "/Users/djw56/Dropbox (Personal)/My Mac (ens-help’s MacBook Pro)/Documents/Research/7LA-Colby/Belgrade Lakes/Lakes/Long Pond/Profiles/LPDEP1 Anoxic Factor.xlsx"
...
st <- '1'
mk <- mk1
png(file="LP1_AF.png", units="in",width=5, height=5.5, res=400)
