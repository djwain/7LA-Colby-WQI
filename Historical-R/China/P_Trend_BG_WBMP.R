...
st <- '1'
mk <- mk1
png(file="China1_PBG_all.png", units="in",width=5, height=5.5, res=400)
...
st <- '2'
mk <- mk1
png(file="China2_PBG_all.png", units="in",width=5, height=5.5, res=400)
...
st <- '3'
mk <- mk1
png(file="China3_PBG_all.png", units="in",width=5, height=5.5, res=400)
