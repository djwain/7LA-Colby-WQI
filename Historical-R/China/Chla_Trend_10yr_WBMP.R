...
st <- '1'
mk <- mk1
png(file="China1_CHLA_10.png", units="in",width=5, height=5.5, res=400)
...
st <- '2'
mk <- mk1
png(file="China2_CHLA_10.png", units="in",width=5, height=5.5, res=400)
...
st <- '3'
mk <- mk1
png(file="China3_CHLA_10.png", units="in",width=5, height=5.5, res=400)
