...
DO2 <- DO2 %>% filter(YDAY >= 105 & YDAY <= 288 & YEAR >= 2011)
...
st <- '1'
mk <- mk1
png(file="China1_anox_10.png", units="in",width=5, height=5.5, res=400)
...
st <- '2'
mk <- mk1
png(file="China2_anox_10.png", units="in",width=5, height=5.5, res=400)
...
st <- '3'
mk <- mk1
png(file="China3_anox_10.png", units="in",width=5, height=5.5, res=400)
