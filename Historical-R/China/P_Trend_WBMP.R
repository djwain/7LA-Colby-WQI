...
st <- '1'
mk <- mk1
png(file="China1_P_all.png", units="in",width=5, height=5.5, res=400)
...
st <- '2'
mk <- mk1
png(file="China2_P_all.png", units="in",width=5, height=5.5, res=400)
...
st <- '3'
mk <- mk1
png(file="China3_P_all.png", units="in",width=5, height=5.5, res=400)
