...
yhigh<-max(Cavg$CHLA)+2

splot <- Cyr1
st <- '1'
mk <- mk1
png(file="GP1_CHLA_all.png", units="in",width=5, height=5.5, res=400)
...
plot(splot$Year,splot$yrmean, las=1, ylim=c(0,yhigh),ylab="Average Jun-Sep CHLA (ppb)",xlab="Year")  
...
st <- '1'
mk <- mk1_10
png(file="GP1_CHLA_10.png", units="in",width=5, height=5.5, res=400)
...
st <- '2'
mk <- mk2
png(file="GP2_CHLA_all.png", units="in",width=5, height=5.5, res=400)
...
st <- '2'
mk <- mk2_10
png(file="GP2_CHLA_10.png", units="in",width=5, height=5.5, res=400)
